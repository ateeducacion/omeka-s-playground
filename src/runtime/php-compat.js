 ...
 * addons.js, and vfs.js.
 */

import { __private__dont__use } from "@php-wasm/universal";

const DEFAULT_WEB_ROOT = "/www/omeka";
 ...
 * expected by the Omeka S Playground codebase.
 */
export function wrapPhpInstance(
  ...
  return {
    ...
    async request(requestOrUrl) {
      ...
      // mod_rewrite "RewriteCond %{REQUEST_FILENAME} !-f" rule that Omeka
      // relies on for clean URLs like /admin, /s/default, etc.
      ...
      const serverVars = {
        ...
        HTTP_USER_AGENT: "OmekaPlayground/1.0 (WASM)",
